...
LOCK TABLES `departments` WRITE;
INSERT INTO `departments` (`id`, `name`, `school`, `min_jamb`, `range_low`, `range_high`, `is_estimated`, `is_health`) VALUES 
(181, 'Data Science', 'SOC', 180, 63.75, 71.00, 1, 0),
(182, 'Mechatronics Engineering', 'SIMME', 180, 71.00, 78.00, 0, 0),
(183, 'Library and Information Science', 'SPS', 180, 47.50, 55.00, 0, 0),
(184, 'Educational Technology', 'SPS', 180, 47.50, 55.00, 0, 0),
(185, 'Nutrition and Dietetics', 'SAAT', 180, 55.00, 62.00, 0, 0),
(186, 'Textile Design Technology', 'SET', 180, 47.50, 55.00, 0, 0);
UNLOCK TABLES;
--
...
UNLOCK TABLES;
-- Insert requirements for missing departments
LOCK TABLES `requirements` WRITE;
INSERT INTO `requirements` (`id`, `department_id`, `jamb_subjects`, `olevel_subjects`) VALUES 
(181, 181, 'English, Math, Physics, Chemistry', '5 Credits: English, Math, Physics, Chemistry, Biology/Comp'),
(182, 182, 'English, Math, Physics, Chemistry', '5 Credits: English, Math, Physics, Chemistry, Biology'),
(183, 183, 'English, Math, Physics, Chemistry/Econs', '5 Credits: English, Math, and 3 relevant Arts/Science subjects'),
(184, 184, 'English, Math, Physics, Chemistry', '5 Credits: English, Math, Physics, Chemistry, Biology'),
(185, 185, 'English, Chemistry, Biology/Agric, Physics/Math', '5 Credits: English, Math, Chemistry, Biology/Agric, Physics'),
(186, 186, 'English, Math, Chem/Phys/Art', '5 Credits: English, Math, Art/Chem/Phys/Bio');
UNLOCK TABLES;
